export const projects = [
  {
    ...
    tool2: 'css',
    tool3: 'javascript',
    linkLive: 'https://ridabensalem.github.io/',
    linkSource: 'https://ridabensalem.github.io/',
  },
  {
    ...
    tool3: 'javascript',
    linkLive: 'https://ridabensalem.github.io/',
    linkSource: 'https://github.com/ridabensalem/',
  },
  {
    name: 'Facebook 360',
    feature: 'FACEBOOK',
...
export function createModal() {
  startingPoint.insertAdjacentHTML(
    ...
    <img src="images/Devider.svg" alt="Divider">
    <ul class='modal__btn ul flex'>
    <li>
    <a href='' class="btn link project-linkLive fw-500 fz-17 lh-24 clr-p-500 bg-white"> See Live <img src="images/deploy.svg"alt="deploying link" class="deploy"></a>
    </li>
    <li>
    <a class="btn link project-linkSource fw-500 fz-17 lh-24 clr-p-500 bg-white">See Source <img src="images/github-popup.svg" alt="github-icon"></a>
    </li>
    </ul>
    </li>
    </ul>
